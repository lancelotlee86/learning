...
class Classifier:
    ...
    def knn(self, itemVector):
        # changed from min to heapq.nsmallest to get the k closest neighbors
        ...
        resultList = sorted([(i[1], i[0]) for i in results.items()],
                            reverse=True)
        # get all the classed that have the maximum votes
...
tenfold("./data/pimaSmall/pimaSmall", "num	num	num	num	num	num	num	num	class", 1)